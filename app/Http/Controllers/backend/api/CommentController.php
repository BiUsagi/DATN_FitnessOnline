...
class CommentController extends Controller
{
    ...
    {
        $supportExercises = Comment::with(['exercise', 'user', 'staff', 'replies.user', 'replies.staff'])
            ->whereNull('rep')
            ->get()
            ->map(function ($item) {
                return [
    ...
    {
        $supportExercise = Comment::with(['exercise', 'user', 'staff', 'replies.user', 'replies.staff'])
            ->where('id', $id) 
            ->first(); 
