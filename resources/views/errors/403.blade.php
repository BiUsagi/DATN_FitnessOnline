...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --animation-sentence: 'Bạn biết là bạn phải rời đi, phải không? ';
        ...
        * {
        ...
        @keyframes showText {
            ...
            100% {
                --animation-sentence: 'Bạn có vẻ quan tâm điều gì sẽ xảy ra tiếp theo nhỉ...';
            }
        }
...
<body>
    <svg style="display: none;">
        <symbol id="keyhole" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
            ...
            <g transform="translate(0 -270.542)">
                <circle cx="13.229" cy="279.141" r="8.599" fill="#fffffe" paint-order="stroke fill markers" />
                <path
                    ...
                    fill="#fffffe" paint-order="stroke fill markers" />
                <circle r="6.06" cy="279.141" cx="13.229" fill="#5f6c7b" paint-order="stroke fill markers" />
                <path
                    ...
                    fill="#5f6c7b" paint-order="stroke fill markers" />
            </g>
        </symbol>
        <symbol id="key" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
            ...
            <circle cx="13.229" cy="279.141" r="8.599" paint-order="stroke fill markers"
                transform="matrix(0 -.76923 .7499 0 -202.882 23.405)" fill="#fffffe" />
            <circle r="8.599" cy="279.141" cx="13.229" paint-order="stroke fill markers"
                transform="matrix(0 -.5887 .57392 0 -153.756 21.017)" fill="#5f6c7b" />
            <path fill="#fffffe" paint-order="stroke fill markers" d="M12.03 12.13h14.428v2.2H12.03z" />
            <path fill="#fffffe" paint-order="stroke fill markers"
        ...
        <symbol id="ghost" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
            ...
            <g transform="translate(0 -270.542)">
                ...
                <ellipse ry=".614" rx="8.082" cy="296.386" cx="13.229" opacity=".1" fill="#5f6c7b"
                    paint-order="stroke fill markers" />
            </g>
        </symbol>
    ...
    <div class="container">
        <h1>403</h1>
        <p>BẠN KHÔNG CÓ QUYỀN TRUY CẬP VÀO ĐỊA CHỈ NÀY</p>
        <a href="{{ route('index') }}" class="link-to-home">
            <p> Về trang chủ </p>
        </a>
        <svg class="keyhole">
            <use href="#keyhole" />
    ...
    <script>
        ...
        const grantAccess = () => {
            ...
            paragraph.textContent = 'chả có gì ở đây cả';
