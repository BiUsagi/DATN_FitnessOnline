                                ...
                                @if (Auth::check())
                                    <li class="nav-item">
                                        @if (Auth::check())
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="username">
                                                <p class="text-center text-white"> <i class="underline">Thông báo</i>
                                                </p>
                                                <hr>
    ...
    <script>
        ...
        $("#btn-login").click(function() {
                    ...
                    $("#btn-login").click(function() {
                        >>>
                        >>>
                        > b5860247c1c1e1ccb43cd1a3d2c31160b7e922e2
                    ...
                    @if (Auth::check())
                        ...
                        $.get('http://127.0.0.1:8000/api/web/wallets/' + userId, function(res) {
                            let data = res;
                            var formattedBalance = data.balance.toLocaleString(
                                'vi-VN'); // Định dạng theo ngôn ngữ Việt Nam
                ...
                $.get('http://127.0.0.1:8000/api/web/get-notification/' + userId, function (res) {
                    ...
                    data.reverse().forEach(element => {
                                    ...
                                    const month = createdAt.getMonth() +
                                        1; // Tháng trong JavaScript bắt đầu từ 0
                    ...
                    $(document).ready(function() {
                        @if (Auth::check())
                            var userId =
                                @json(Auth::user()->id); // Truyền id người dùng từ PHP sang JavaScript
