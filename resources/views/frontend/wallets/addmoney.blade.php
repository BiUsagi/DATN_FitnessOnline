                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-md-4 ">
                                        <div class="form-check">
                                            <input value="10.000" class="form-check-input" type="radio" name="money"
                                                id="money1" checked>
                                        ...
                                        <div class="form-check">
                                            <input value="20.000" class="form-check-input" type="radio" name="money"
                                                id="money2">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-md-4 ">
                                        <div class="form-check">
                                            <input value="50.000" class="form-check-input" type="radio" name="money"
                                                id="money3">
                                        ...
                                        <div class="form-check">
                                            <input value="100.000" class="form-check-input" type="radio" name="money"
                                                id="money4">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-md-4 ">
                                        <div class="form-check">
                                            <input value="200.000" class="form-check-input" type="radio" name="money"
                                                id="money5">
                                        ...
                                        <div class="form-check">
                                            <input value="500.000" class="form-check-input" type="radio" name="money"
                                                id="money6">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-md-4 ">
                                        <div class="form-check">
                                            <input value="1.000.000" class="form-check-input" type="radio" name="money"
                                                id="money7">
                                        ...
                                        <div class="form-check">
                                            <input value="2.000.000" class="form-check-input" type="radio" name="money"
                                                id="money8">
