                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-md-5 col-12 pt-3" id="modal-left">
                            ...
                            <div class="list-voucher">
                                @for ($i = 1; $i <= $package->duration_days; $i++)
                                    <div class="box-day text-info">
                                        <span class="day"><i class="bi bi-ticket-perforated-fill"></i> Giảm 25%</span>
                            ...
                            <div class="input-group mb-3 mt-1">
                                ...
                                <input class="btn btn-outline-secondary" type="button" id="button-addon2" value="dd">
                            </div>
...
<script>
    @if (Auth::check())
        ...
        $('#button-pay').html('<button type="button" class="by-now" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Mua ngay</button>')
    @else
