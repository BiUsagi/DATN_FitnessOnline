                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="banner-slide">
                            <img loading='lazy' data-swiper-parallax="-700" src="assets/images/banner/banner-1.webp" alt="banner-slide" width="416" height="666">
                    ...
                    <div class="swiper-slide">
                        <div class="banner-slide">
                            <img loading='lazy' data-swiper-parallax="-700" src="assets/images/banner/banner-2.webp" alt="banner-slide" width="375" height="600">
                            <div class="banner-text">
                                <h2 data-swiper-parallax="-800">BUILD YOUR</h2>
                    ...
                    <div class="swiper-slide">
                        <div class="banner-slide">
                            <img loading='lazy' data-swiper-parallax="-700" src="assets/images/banner/banner-3.webp" alt="banner-slide" width="517" height="600">
                            <div class="banner-text">
                        ...
                        <div class="row">
                            <div class="col-md-4 f-0">
                                <div class="team-block">
                                    <img loading='lazy' src="assets/images/team/1.webp" alt="Coaches" width="210" height="339">
                                    <h3>Joshua <span>Franklin</span></h3>
                                </div>
                            </div>
                            <div class="col-md-4 f-0">
                                <div class="team-block">
                                    <img loading='lazy' src="assets/images/team/2.webp" alt="Coaches" width="210" height="339">
                                    <h3>Reflina <span>Deovanger</span></h3>
                                </div>
                            </div>
                            <div class="col-md-4 f-0">
                                <div class="team-block">
                                    <img loading='lazy' src="assets/images/team/3.webp" alt="Coaches" width="210" height="339">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="feature-list">
                                <img loading='lazy' src="assets/images/icons/courses-1.svg" alt="icons" width="60" height="60">
                                <span>GYM</span>
                                ...
                                <div class="button-sec">
                                    <a href="#!">Read More</a>
                                    <a href="#!"><img loading='lazy' src="assets/images/icons/btn-arrow.svg" alt="icon" width="25" height="14"></a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="feature-list">
                                <img loading='lazy' src="assets/images/icons/courses-2.svg" alt="icons" width="60" height="60">
                                <span>GYM</span>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-list">
                                <img loading='lazy' src="assets/images/icons/courses-3.svg" alt="icons" width="60" height="60">
                                <span>GYM</span>
                                <h2>Running</h2>
                                <p>Morbi commodo sapien at risus aliquam dapibus. Quisque ullamcorper ex non leo blandit
                                    porta. </p>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-list">
                                <img loading='lazy' src="assets/images/icons/courses-4.svg" alt="icons" width="60" height="60">
                                <span>GYM</span>
                                <h2>Meditation</h2>
                                <p>Morbi commodo sapien at risus aliquam dapibus. Quisque ullamcorper ex non leo blandit
                                    porta. </p>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-list">
                                <img loading='lazy' src="assets/images/icons/courses-5.svg" alt="icons" width="60" height="60">
                                <span>GYM</span>
                                <h2>Body Building</h2>
                                <p>Morbi commodo sapien at risus aliquam dapibus. Quisque ullamcorper ex non leo blandit
                                    porta. </p>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-list">
                                <img loading='lazy' src="assets/images/icons/courses-6.svg" alt="icons" width="60" height="60">
                                <span>GYM</span>
                    ...
                    <div class="col-lg-4 col-md-8 mx-auto mb-xl-0 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">It’s no secret that the digital industry is booming. From exciting startups to global brands, companies are reaching out to digital agencies, responding to the new possibilities available. </p>
                                <div class="button-sec">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="#!" class="slides" aria-label="Slide 1">
                                <img loading='lazy' src="assets/images/post/post-1.webp" alt="Post Image" width="309" height="309">
                                <div class="links">
                        ...
                        <div class="swiper-slide">
                            <a href="#!" class="slides" aria-label="Slide 2">
                                <img loading='lazy' src="assets/images/post/post-2.webp" alt="Post Image" width="309" height="309">
                                <div class="links">
                                    <img loading='lazy' src="assets/images/icons/link.svg" alt="icon">
                                </div>
                            </a>
                        ...
                        <div class="swiper-slide">
                            <a href="#!" class="slides" aria-label="Slide 3">
                                <img loading='lazy' src="assets/images/post/post-3.webp" alt="Post Image" width="309" height="309">
                                <div class="links">
                                    <img loading='lazy' src="assets/images/icons/link.svg" alt="icon">
                                </div>
                            </a>
                        ...
                        <div class="swiper-slide">
                            <a href="#!" class="slides" aria-label="Slide 3">
                                <img loading='lazy' src="assets/images/post/post-4.webp" alt="Post Image" width="309" height="309">
                                <div class="links">
                                    <img loading='lazy' src="assets/images/icons/link.svg" alt="icon">
                                </div>
                            </a>
